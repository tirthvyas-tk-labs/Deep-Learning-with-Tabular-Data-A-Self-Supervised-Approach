# -*- coding: utf-8 -*-
"""Adult_Income_TL_binned.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wISGQBAg9rZdfY4AyOuIUG9FFg-Ttaug
"""
...
data_bin_df = binning_numerical(source_domain_male_df, numerical_features, n_bins=n_bins)

categorical_features = ['age', 'workclass', 'fnlwgt', 'education', 'education.num',
       'marital.status', 'occupation', 'relationship', 'race', 'sex',
...
train_data = data_bin_df[val_size:]
...
n_bins = exp_config['n_bins']
data_bin_df_female = binning_numerical(target_domain_female_df, numerical_features, n_bins=n_bins)
...
bin_supervised_90_percent_target_domain_female, bin_supervised_10_percent_target_domain_female = train_test_split(data_bin_df_female, test_size=0.1, random_state=42)
...
X = bin_supervised_10_percent_target_domain_female.pop('income')
y = supervised_10_percent_target_domain_female['income']

X_test = bin_supervised_90_percent_target_domain_female.pop('income')
y_test = supervised_90_percent_target_domain_female['income']
...
categorical_features_10_90 = ['age', 'workclass', 'fnlwgt', 'education', 'education.num',
       'marital.status', 'occupation', 'relationship', 'race', 'sex',
       'capital.gain', 'capital.loss', 'hours.per.week', 'native.country',
       'income']
