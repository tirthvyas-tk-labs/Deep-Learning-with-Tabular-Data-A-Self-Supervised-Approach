# -*- coding: utf-8 -*-
"""Adult_Income_TL_Vanilla.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XbRlgbGF4dsB3bkQ46Dt2Q9vCENvMUfr
"""
...
training_model1 = TabTransformer1(categorical_features, numerical_features,
                                       lookup_layers,
...
# Model FLow
keras.utils.plot_model(training_model1, show_shapes=True, rankdir="LR")
...
training_model1.compile(optimizer=optimizer,
                       loss=loss_fn,
...
for l, layer in enumerate(training_model1.layers):
    layer.trainable = False

inputs = training_model1.input

x = training_model1.output
